...
class LMUKolloquiumSpider(CrawlSpider):
    ...
    rules = (
        Rule(SgmlLinkExtractor(allow=('physik_kolloquium/mpk_tum_\d{1,}/index\.html', 
                                      'physik_kolloquium/mpk_lmu_\d{1,}/index\.html',) ), callback = 'parse_item', follow = True),)
...
#            speaker = speaker_details
        ...
        item['summary'] = u"M\u00FCnchner Physik Kolloquium: " + title      
